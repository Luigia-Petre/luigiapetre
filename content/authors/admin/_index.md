...
education:
  courses:
  - course: PhD in Computer Science on Modeling Techniques with Formal Methods (titled  {{< staticref "https://tucs.fi/publications/view/?pub_id=phdPetre05a" "newtab" >}}"Modeling with Action Systems"{{< /staticref >}}) 
